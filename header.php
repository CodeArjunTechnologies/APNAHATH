        ...
        <div class="container-fluid bg-primary px-5 d-none d-lg-block">
            <div class="row gx-0 align-items-center">
                <div class="col-lg-5 text-center text-lg-start mb-lg-0">
                    <div class="d-flex">
                        <a href="#" class="text-muted me-4"><i class="fas fa-envelope text-secondary me-2"></i> <span style="color: white;">apnahath.care@gmail.com </span> </a>
                        <a href="#" class="text-muted me-0"><i class="fas fa-phone-alt text-secondary me-2"></i>  <span style="color: white;">+91-8794180180 </span> </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 text-center text-lg-end">
                    <div class="d-inline-flex align-items-center" style="height: 45px;">
                        <a href="#" class="text-muted me-2"> <span style="color: white;"> Privacy Policy </span> </a>
        ...
        <div class="container-fluid nav-bar p-0">
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <!-- <h1 class="display-5 text-secondary m-0"><img src="img/logo.svg" class="img-fluid" alt="">Apnahath</h1> -->

                    <h1 class="display-5 text-secondary m-0">
                        <img src="img/logo2.png" class="img-fluid" alt="" style="height: 100px; width: auto;"><!-- <span style="color: skyblue;"> apna</span><span style="color: black;">hath </span> -->
                    </h1>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="service.php" class="nav-item nav-link">Category</a>
                    ...
                    <a href="https://play.google.com/store/apps/details?id=com.apnahath.application.user" class="btn btn-primary border-secondary rounded-pill py-2 px-4 px-lg-3 mb-3 mb-md-3 mb-lg-0">Download App</a>
                </div>
            </nav>
        </div>