            ...
            <div class="container py-5">
                <div class="row g-5 mb-5">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                        ...
                        <p class="mb-5">Need help or have a question? Our team is here to assist you with prompt and friendly support. Reach out anytime!</p>
                        <div class="d-flex border-bottom mb-4 pb-4">
                            <i class="fas fa-map-marked-alt fa-4x text-primary bg-light p-3 rounded"></i>
                            <div class="ps-3">
                                <h5>Location</h5>
                                <p>MIlansangha, Agartala, West Tripura</p>
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-xl-12">
                                   ...
                                   <div class="row">
                                    <div class="col-md-6 mb-3">
                                     <h6 class="mb-0">Phone:</h6>
                                       <a href="tel:+918794180180" class="fs-5 text-primary">+91-8794180180</a>
                                    </div>
                                    
                                      <div class="col-md-6 mb-3">
                                        <h6 class="mb-0">Email:</h6>
                                           <a href="mailto:apnahath.care@gmail.com" class="fs-5 text-primary">apnahath.care@gmail.com</a>
                                       </div>
                                    </div>
                                </div>
                             </div>
                           ...
                           <!--  <div class="col-xl-12">
                                <div class="d-flex">
                                    ...
                                    <div class="ps-3">
                                        ...
                                        <div class="mb-3">
                                            <h6 class="mb-0">Phone:</h6>
                                            <a href="#" class="fs-5 text-primary">+91-8794180180</a>
                                        </div>
                                        <div class="mb-3">
                                            <h6 class="mb-0">Email:</h6>
                                            <a href="#" class="fs-5 text-primary">apnahath.care@gmail.com</a>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3">
                        ...
                        <form method="post" action="contact_form_action.php">
                            <div class="row g-4">
                    ...
                    <div class="row g-4 justify-content-center">
                        ...
                        <div class="col-12 pt-5 wow zoomIn" data-wow-delay="0.1s">
                            <div class="rounded h-100">
                                ...
                                style="height: 500px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3649.8589206304005!2d91.268811375166!3d23.823615278620522!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3753f5c0e4fa8723%3A0x1c87420625cf282d!2sApnahath!5e0!3m2!1sen!2sin!4v1754295778019!5m2!1sen!2sin" width="600" height="450" 
