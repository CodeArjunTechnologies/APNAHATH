...
<?php
$sql = "SELECT s.id, s.name AS service_name, s.description, s.image, s.created_at,
               sub.name AS subcategory_name
        FROM apna_hath_services s
        INNER JOIN apna_hath_subcategory sub 
            ON s.subcategory_id = sub.id
        ORDER BY s.id DESC;";
...
if (isset($_GET['delid']) && isset($_GET['ppic'])) {
    ...
    $query = "DELETE FROM apna_hath_services WHERE id = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("i", $id);
    
    if ($stmt->execute()) {
        echo "<script>alert('Service deleted successfully'); window.location='view_service.php';</script>";
    } else {
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      <div class="page-header row">
        ...
        <div class="col-4 col-xl-4 page-title">
          <h4 class="f-w-700">Service Details</h4>
          <nav>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>  
                              ...
                              <td>
                                <ul class="action"> 
                                  <li class="delete" ><a href="view_service.php?delid=<?php echo $row['id']; ?>&ppic=<?php echo $row['image']; ?>" onclick="return confirm('Do you really want to Delete ?');"><i class="icon-trash"></i></a></li>
                                </ul>  
                              </td>
