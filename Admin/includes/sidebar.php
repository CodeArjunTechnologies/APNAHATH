<div class="sidebar-wrapper" data-layout="stroke-svg">
    ...
    <!-- <a href="#" style="text-decoration: none; font-size: 24px; font-weight: bold; color: white;">
        Suman Sir's Commerce Class
    </a> -->


              <a href="#"><img class="img-fluid" src="../img/logo.png" alt="" height="80" width="80"></a>
            ...
            <div class="logo-icon-wrapper"><a href="#"><img class="img-fluid" src="../img/logo.png" alt="" height="80" width="80"></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="#"><img class="img-fluid" src="../img/logo.png" alt=""></a>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="change_password.php">
                      <svg class="stroke-icon">
                  ...
                  <!-- <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      </svg><span class="lan-6">Appointments</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="view_appoinment.php">View Appointments</a></li>
                 ...
                 <!--  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                  ...
                  <!--  <li class="sidebar-list"><i class="fa fa-thumb-tack">    </i><a class="sidebar-link sidebar-title" href="view_admissions.php">
                      <svg class="stroke-icon">
                        <use href="assets/svg/icon-sprite.svg#stroke-blog"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-blog"></use>
                      </svg><span>Admissions</span></a>
                  </li>


                   <li class="sidebar-list"><i class="fa fa-thumb-tack">    </i><a class="sidebar-link sidebar-title" href="view_enrollment_courses.php">
                      <svg class="stroke-icon">
                        <use href="assets/svg/icon-sprite.svg#stroke-blog"></use>
                      </svg>
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-blog"></use>
                      </svg><span>Enrollment Courses</span></a>
                  </li>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack">    </i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-blog"></use>
                      </svg><span>Student Of The Month</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="add_student_of_the_month.php">Add Student</a></li>
                      <li><a href="view_student_of_the_month.php">View Student</a></li>
                    </ul>
                  </li>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack">    </i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-blog"></use>
                      </svg><span>Expenditure</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="view_expenditure_category.php">Category</a></li>
                      <li><a href="add_expenditure.php">Expenditure</a></li>
                      <li><a href="monthly_yearly_calculate.php">Expenditure Calculate</a></li>
                    </ul>
                  </li> -->
                 ...
                 <!--  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                    ...
                    <ul class="sidebar-submenu">
                      ...
                      <li><a href="view_image.php">View Images</a></li>
