...
$subcategories = mysqli_query($conn, "SELECT id, name FROM apna_hath_subcategory");
...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO apna_hath_services (subcategory_id, name, description, image) 
              VALUES ('$subcategory_id', '$name', '$description', '$image')";
    

    if (mysqli_query($conn, $query)) {
        echo "<script>alert('Service added successfully'); window.location='view_service.php';</script>";
    } else {
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      <div class="page-header row">
        ...
        <div class="col-4 col-xl-4 page-title">
          <h4 class="f-w-700">Add Service</h4>
        </div>
        <!-- Page Header Start-->
...
<form method="POST" enctype="multipart/form-data">
    ...
    <select class="form-control up" type="text"  name="subcategory_id" required>
    ...
    <input class="form-control up" type="text"  type="text" name="name" required><br><br>

    <label  class="form-label" for="first-name">Description</label>
    <textarea class="form-control up" type="text"  name="description"></textarea><br><br>

    <label  class="form-label" for="first-name">Image</label>
    <input class="form-control up" type="file" name="image"><br><br>

    <button name="submit" class="btn btn-primary" type="submit" id="submit">Add Service</button>
</form>
