...
<?php include('dbcon.php'); ?>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Our Sub Categories</h1>
                <ol class="breadcrumb justify-content-center text-white mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.php" class="text-white">Home</a></li>
                    <li class="breadcrumb-item"><a href="#" class="text-white">Pages</a></li>
                    <li class="breadcrumb-item active text-secondary">Sub Categories</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
...
if (isset($_GET['id'])) {
    ...
    $sql_cat = "SELECT name, description FROM apna_hath_category WHERE id = '$category_id' LIMIT 1";
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM apna_hath_subcategory WHERE category_id = '$category_id' ORDER BY id DESC";
                ...
                <div class="service-title">
                    <div class="service-title-name">
                        <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                            <a href="details_services.php?id=<?php echo $row['id']; ?>" class="h4 text-white mb-0">
                                <?php echo htmlspecialchars($name); ?>
                            </a>
                        </div>
                        <a class="btn bg-light text-secondary rounded-pill py-1 px-3 mb-2" href="services.php?id=<?php echo $row['id']; ?>">View Services</a>
                    </div>
                    <div class="service-content pb-4">
                        <a href="details_services.php?id=<?php echo $row['id']; ?>">
                            <h4 class="text-white mb-3 py-3"><?php echo htmlspecialchars($name); ?></h4>
                        </a>
                        <div class="px-4">
                            <p class="mb-4"><?php echo htmlspecialchars($description); ?></p>
                            <a class="btn btn-primary border-secondary rounded-pill py-1 px-3" href="details_services.php?id=<?php echo $row['id']; ?>">View Services</a>
                        </div>
                    </div>
                </div>
            </div>
